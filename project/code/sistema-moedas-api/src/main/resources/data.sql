...
INSERT INTO student (name, email, cpf, rg, educational_institution_id, course_id)
VALUES ('Lucas Almeida', 'lucas.almeida@example.com', '12345678901', 'MG1234567', 1, 5),
       ('Ana Beatriz Souza', 'ana.souza@example.com', '23456789012', 'MG2345678', 2, 12),
       ('Pedro Henrique Santos', 'pedro.santos@example.com', '34567890123', 'MG3456789', 3, 20),
       ('Mariana Oliveira', 'mariana.oliveira@example.com', '45678901234', 'MG4567890', 1, 14),
       ('Gabriel Ferreira', 'gabriel.ferreira@example.com', '56789012345', 'MG5678901', 4, 22),
       ('Julia Pereira', 'julia.pereira@example.com', '67890123456', 'MG6789012', 5, 28),
       ('Rafael Costa', 'rafael.costa@example.com', '78901234567', 'MG7890123', 6, 35),
       ('Isabela Rodrigues', 'isabela.rodrigues@example.com', '89012345678', 'MG8901234', 2, 43),
       ('Bruno Martins', 'bruno.martins@example.com', '90123456789', 'MG9012345', 3, 18),
       ('Larissa Silva', 'larissa.silva@example.com', '01234567890', 'MG0123456', 1, 27),
       ('Mateus Lima', 'mateus.lima@example.com', '10234567891', 'MG1023456', 4, 10),
       ('Camila Rocha', 'camila.rocha@example.com', '11234567892', 'MG1123456', 5, 50),
       ('Felipe Nunes', 'felipe.nunes@example.com', '12234567893', 'MG1223456', 6, 3),
       ('Aline Cardoso', 'aline.cardoso@example.com', '13234567894', 'MG1323456', 2, 38),
       ('Rodrigo Barros', 'rodrigo.barros@example.com', '14234567895', 'MG1423456', 3, 19),
       ('Patricia Mendes', 'patricia.mendes@example.com', '15234567896', 'MG1523456', 1, 6),
       ('Tiago Freitas', 'tiago.freitas@example.com', '16234567897', 'MG1623456', 4, 45),
       ('Vanessa Ribeiro', 'vanessa.ribeiro@example.com', '17234567898', 'MG1723456', 5, 61),
       ('Diego Araujo', 'diego.araujo@example.com', '18234567899', 'MG1823456', 6, 8),
       ('Fernanda Costa', 'fernanda.costa@example.com', '19234567890', 'MG1923456', 2, 32);
